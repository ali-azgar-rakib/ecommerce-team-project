                        ...
                        <div class="owl-carousel owl-theme deals_slider">
                            ...
                            <div class="owl-item deals_item">
                                <div class="deals_image"><img
                                        src="{{ asset('img/media/products/'.$hot_deal->image_one) }}" alt="">
                                </div>
                                <div class="deals_content">
                                    <div class="deals_info_line d-flex flex-row justify-content-start">
                                        <div class="deals_item_category"><a
                                                href="#">{{ $hot_deal ->brand->brand_name }}</a></div>
                                        @if ($hot_deal->discount_price)
                                    ...
                                    <div class="deals_info_line d-flex flex-row justify-content-start">
                                        ...
                                        @else
                                        <div class="deals_item_price ml-auto">${{ $hot_deal->selling_price }}</div>
                                    ...
                                    <div class="available">
                                        <div class="available_line d-flex flex-row justify-content-start">
                                            <div class="available_title">Available:
                                                <span>{{ $hot_deal->product_quantity }}</span></div>
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <img src="{{ asset('img/media/products/'.$trend->image_one) }}" alt="">
                                        </div>
                                        ...
                                        <ul class="product_marks">
                                            ...
                                            <li class="product_mark product_discount">
                                                -{{ round(($trend->selling_price - $trend->discount_price)/$trend->selling_price *100) }}
                                                %
                                            </li>
                                            @else
                                            <li class="product_mark product_discount" style="background: #0e8ce4;">New
                                            </li>
                                            @endif
                                        </ul>
                                    </div>
                            ...
                            <div class="featured_slider slider">
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="product_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset('img/media/products/'.$on_sale->image_one) }}" alt="">
                                        </div>
                                        <div class="product_content">
                                            @if ($on_sale->discount_price)
                                            <div class="product_price discount">
                                                ${{ $on_sale->discount_price }}<span>${{ $on_sale->selling_price }}</span>
                                            </div>
                                            @else
                                            <div class="product_price discount">${{ $on_sale->selling_price }}</div>
                                        ...
                                        <ul class="product_marks">
                                            ...
                                            <li class="product_mark product_discount">
                                                -{{ round(($on_sale->selling_price - $on_sale->discount_price)/$on_sale->selling_price *100) }}
                                                % </li>
                                            @else
                                            <li class="product_mark product_discount" style="background: #0e8ce4;">New
                                            </li>
                            ...
                            <div class="featured_slider slider">
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="product_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset('img/media/products/'.$best_rated->image_one) }}" alt="">
                                        </div>
                                        <div class="product_content">
                                            @if ($best_rated->discount_price)
                                            <div class="product_price discount">
                                                ${{ $best_rated->discount_price }}<span>${{ $best_rated->selling_price }}</span>
                                            </div>
                                            @else
                                            <div class="product_price discount">${{ $best_rated->selling_price }}</div>
                                        ...
                                        <ul class="product_marks">
                                            ...
                                            <li class="product_mark product_discount">
                                                -{{ round(($best_rated->selling_price - $best_rated->discount_price)/$best_rated->selling_price *100) }}
                                                % </li>
                                            @else
                                            <li class="product_mark product_discount" style="background: #0e8ce4;">New
                                            </li>
                        ...
                        <div class="owl-item">
                            <div class="popular_category d-flex flex-column align-items-center justify-content-center">
                                <div class="popular_category_image"><img
                                        src="{{ asset('frontend') }}/images/popuar_1.png" alt="">
                                </div>
                                <div class="popular_category_text">{{ $popular_category -> category_name }}</div>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="row fill_height">
                            <div class="col-lg-4 col-md-6 fill_height">
                                <div class="banner_2_content">
                                    <div class="banner_2_category">{{ $mid_slider->category->category_name }}</div>
                                    <div class="banner_2_title">{{ $mid_slider->product_name }}</div>
                                    <div class="banner_2_text">{{ $mid_slider->brand->brand_name }}</div>
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img style="width: 500px"
                                            src="{{ asset('img/media/products/'.$mid_slider->image_one) }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col">
                <div
                    ...
                    <div class="newsletter_content clearfix">
                        <form method='post' action="{{ route('newslater') }}" class="newsletter_form">
                            @csrf
