                        ...
                        <ul class="cat_menu">
                            ...
                            <li class="hassubs">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">{{ $sub_category->sub_category_name }}<i
...
<div class="banner">
    ...
    <div class="container fill_height">
        <div class="row fill_height">
            <div class="banner_product_image"><img src="{{ asset('img/media/products/'.$main_slider->image_one) }}"
                    alt=""></div>
            <div class="col-lg-5 offset-lg-4 fill_height">
                <div class="banner_content">
                    ...
                    <div class="banner_price">
                        <span>${{ $main_slider->selling_price }}</span>${{ $main_slider->discount_price }}</div>
                    @else
                    <div class="banner_price">${{ $main_slider->selling_price }}</div>
                    @endif
                    <div class="banner_product_name">{{ $main_slider -> product_name }}</div>
