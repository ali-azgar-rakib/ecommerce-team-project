    ...
    <div class="card pd-20 pd-sm-40">
        ...
        <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap text-center">
                ...
                <tbody>
                    @foreach ($newslatters as $key=>$newslater)
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm " id="edit"
                                data-id="{{ $newslater->id }}">edit</button>
                            <button class="btn btn-warning btn-sm  " id="delete"
                                data-id="{{ $newslater->id }}">delete</button>
...
<div id="modaldemo4" class="modal fade">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
            ...
            <form method="post" action="{{ url('/admin/newslater/updated') }}">
                @csrf
...
$("body").on('click',"#edit",function() {
    let id = $(this).data('id')
    $.get(`/admin/newslater/${id}/edit`,function(data) {
        $("#dataid").val(id)
