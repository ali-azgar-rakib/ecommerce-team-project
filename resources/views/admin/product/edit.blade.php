                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <select name="sub_category_id" class="form-control select2"
                                        ...
                                        <option value="{{ $product->brand_id }}">{{ $product->brand->brand_name }}
                                        </option>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" name="product_details"
                                        value='{{ $product->product_details }}'>{{ $product->product_details }}
                                    </textarea>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="custom-file">
                                        ...
                                        <img width='80' src="{{ asset('img/media/products/'.$product->image_one) }}"
                                            id='one' />
                                        @error('image_one')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <img width='80' src="{{ asset('img/media/products/'.$product->image_two) }}"
                                        id='two' />
                                    @error('image_two')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <img width='80' src="{{ asset('img/media/products/'.$product->image_three) }}"
                                        id='three' />
                                    @error('image_three')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
